 ...
 * ProForm 支持的相关类型
 */
export declare type ProFormPropsType<T, ValueType = 'text'> = ((({
    layoutType?: 'Form';
} & ProFormProps<T>) | ({
...
export declare type ProFormRenderValueTypeItem<T, ValueType> = {
    label: any;
    getFieldProps?: () => any;
    getFormItemProps?: () => any;
} & ProFormColumnsType<T, ValueType>;
export declare type ProFormRenderValueTypeHelpers<T, ValueType> = {
...
export declare type ItemType<T, ValueType> = Omit<ProFormRenderValueTypeItem<T, ValueType>, 'key'> & {
    key?: React.Key | React.Key[];
};
export declare type ProSchemaRenderValueTypeFunction<T = any, ValueType = any> = (item: ItemType<T, ValueType>, helpers: ProFormRenderValueTypeHelpers<T, ValueType>) => React.ReactNode;
